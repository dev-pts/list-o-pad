module SubModule(
	...
	output reg [1:0] g_0__d__b,
	output reg g_1__c,
	input wire g_1__d__a,
	output reg [1:0] g_1__d__b,
	input wire h_0__c,
	output reg h_0__d__a,
	input wire [1:0] h_0__d__b,
	input wire h_1__c,
	output reg h_1__d__a,
	input wire [1:0] h_1__d__b,
	input wire h_2__c,
	output reg h_2__d__a,
	input wire [1:0] h_2__d__b
);
endmodule
...
module test(
	output reg a__c,
	input wire a__d__a,
	output reg [1:0] a__d__b,
	input wire b__c,
	output reg b__d__a,
	input wire [1:0] b__d__b
);
	wire c__e__c;
	reg c__e__d__a;
	wire [1:0] c__e__d__b;
	...
	wire c__g_0__c;
	reg c__g_0__d__a;
	wire [1:0] c__g_0__d__b;

	wire c__g_1__c;
	reg c__g_1__d__a;
	wire [1:0] c__g_1__d__b;


	reg c__h_0__c;
	wire c__h_0__d__a;
	reg [1:0] c__h_0__d__b;

	reg c__h_1__c;
	wire c__h_1__d__a;
	reg [1:0] c__h_1__d__b;

	reg c__h_2__c;
	wire c__h_2__d__a;
	reg [1:0] c__h_2__d__b;
	...
	wire d_0__g_0__c;
	reg d_0__g_0__d__a;
	wire [1:0] d_0__g_0__d__b;

	wire d_0__g_1__c;
	reg d_0__g_1__d__a;
	wire [1:0] d_0__g_1__d__b;


	reg d_0__h_0__c;
	wire d_0__h_0__d__a;
	reg [1:0] d_0__h_0__d__b;

	reg d_0__h_1__c;
	wire d_0__h_1__d__a;
	reg [1:0] d_0__h_1__d__b;

	reg d_0__h_2__c;
	wire d_0__h_2__d__a;
	reg [1:0] d_0__h_2__d__b;
	...
	wire d_1__g_0__c;
	reg d_1__g_0__d__a;
	wire [1:0] d_1__g_0__d__b;

	wire d_1__g_1__c;
	reg d_1__g_1__d__a;
	wire [1:0] d_1__g_1__d__b;


	reg d_1__h_0__c;
	wire d_1__h_0__d__a;
	reg [1:0] d_1__h_0__d__b;

	reg d_1__h_1__c;
	wire d_1__h_1__d__a;
	reg [1:0] d_1__h_1__d__b;

	reg d_1__h_2__c;
	wire d_1__h_2__d__a;
	reg [1:0] d_1__h_2__d__b;
